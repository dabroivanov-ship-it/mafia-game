...
export const INFO_PAGE_META: Record<string, PageMeta> = {
  hub: {
    ...
    description:
      'Правила игры «Мафия онлайн», описание ролей, игры с AI-агентами, правила чата и команда проекта. Всё для новичков и опытных игроков.',
    path: '/info',
  },
  rules: {
    title: 'Правила игры',
  ...
  aiAgents: {
    ...
    description:
      'Как играть в мафию с AI-агентами: комнаты с меткой «ИИ», роли ботов, чат, голосование и ночные ходы по тем же правилам, что у людей.',
    path: '/info/ai',
  },
  chatRules: {
    title: 'Правила чата',
