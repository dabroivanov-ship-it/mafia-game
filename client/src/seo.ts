...
export const DEFAULT_PAGE_META: PageMeta = {
  title: 'Мафия онлайн — играть бесплатно',
  description:
    'Бесплатная онлайн-игра «Мафия» с чатом, ролями и комнатами. Играйте в браузере или через Telegram: мафия, комиссар, доктор, маньяк и другие роли.',
  path: '/',
};
...
export const INFO_PAGE_META: Record<string, PageMeta> = {
  ...
  roles: {
    title: 'Игровые роли',
    description:
      'Описание ролей в онлайн-игре Мафия: мафия, Катани, доктор, путана, бомж, маньяк, клоун, горец и другие. Состав зависит от числа игроков.',
    path: '/info/roles',
  },
  chatRules: {
    title: 'Правила чата',
